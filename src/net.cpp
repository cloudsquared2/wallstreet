...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Blockwallstreetcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"173.249.63.71", "173.249.63.71"},
    {"178.238.233.23", "178.238.233.23"}, 	
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"blockwallstreetcointools.com", "testnet-seed.blockwallstreetcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Blockwallstreetcoin is probably already running."), addrBind.ToString().c_str());
        else
